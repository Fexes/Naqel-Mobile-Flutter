...
import 'package:progress_dialog/progress_dialog.dart';
      ...
      class TraderQuestionsPage extends StatefulWidget  {


        const TraderQuestionsPage({Key key}) : super(key: key);
      ...
      class _PermitPageState extends State<TraderQuestionsPage>  {

        List<TraderQuestions>  questions;
        ...
        Future<void> loadQuestions() async {
          ...
          try{
          final request = await client.getUrl(Uri.parse(URLs.tradersgetQuestionsURL()));
          ...
          response.transform(utf8.decoder).listen((contents) async {
            ...
            DataStream.traderquestions = DataStream.parseTraderQuestions(map["Questions"]);
            print(map["Questions"]);
            questions=DataStream.traderquestions;
            dataloaded=true;
                            ...
                            Column(
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  ...
                                  child:
                                  questions[index].traderAnswer!=null?
                                  Text(
                                    '${questions[index].traderAnswer.Answer}',
                                                                  ...
                                                                  children: <Widget>[
                                                                    ...
                                                                    Column(
                                                                      ...
                                                                      children: <Widget>[
                                                                        ...
                                                                        Text(
                                                                          '${questions[index].traderAnswer.answeredBy.FirstName} ${questions[index].traderAnswer.answeredBy.LastName}',
                                                                          style: TextStyle(
                                                                            color: AppTheme.grey,
                                                                            fontSize: 12,
                                                                          ),
       ...
       //   pr.show();
          ...
          final client = HttpClient();
          try{
          final request = await client.postUrl(Uri.parse(URLs.tradersaddQuestionURL()));
          request.headers.set(HttpHeaders.contentTypeHeader, "application/json; charset=UTF-8");
          request.headers.add("Authorization", "JWT "+DataStream.token);
  ...
  Future<void> deleteQuestion(int id) async {
    ...
    final client = HttpClient();
    try{
    final request = await client.deleteUrl(Uri.parse(URLs.tradersdeleteQuestionURL()));
    request.headers.set(HttpHeaders.contentTypeHeader, "application/json; charset=UTF-8");
    request.headers.add("Authorization", "JWT "+DataStream.token);
